  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow">
        <h3
          className="text-black font-semibold mb-2 line-clamp-2 min-h-[3rem] product-title"
          title={product.name}
        >
          {product.name}
        </h3>
        ...
        <div className="mt-auto mb-2 flex flex-col">
          ...
          {product.cprice && (
            <span className="text-black text-sm line-through">{decodeHtml(product.cprice)}</span>
          )}
        </div>
